...
const AboutMe = () => {
	...
	return (
		<div className='aboutMe'>
			...
			<p className='aboutText'>
				As a developer I enjoy making web pages fast and easy to use, while applying the latest technologies. My background as a scientist has helped give me a sharp and disciplined attention to detail. I also have a very strong artistic side, the result of being involved in Hip Hop culture (as a dancer and artist) for over 20 years. My graphic design, video editing and brush lettering skills developed from a love for graffiti and street art. The approach I took to learning dances like b-boying and locking has helped me become a creative artist, community leader and problem solver while also developing effective teaching methods.
			</p>
			<p className='aboutText'>
