  ...
  return (
    <div className="aboutMe" id="about">
      ...
      <p className="aboutText">
        Based in Montréal, Québec, Canada, I'm a highly motivated, self-taught
      ...
      <p className="aboutText">
        As a developer I enjoy making web pages fast and easy to use, while
        ...
        side, the result of being involved in Hip Hop culture (as a dancer and
        artist) for over 20 years. My graphic design, video editing and brush
      ...
      <p className="aboutText">
        I've travelled the world, working with people from all walks of life.
        Following the motto of "each one, teach one", I truly believe we all
        have something special to bring to the table.{" "}
        <a className="touchLink" href="#contact">
          <b>Get in touch</b>
        </a>
        {" "}
        to see what I can bring to your team!
      </p>
    </div>
  );
};
